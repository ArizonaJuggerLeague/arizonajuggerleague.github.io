...
<xsl:template match="/rss">
	...
	<link rel="stylesheet" type="text/css" href="http://localhost:4000/assets/css/styles_feeling_responsive_light.css">
...
<ul class="accordion row" data-accordion="">
	<xsl:for-each select="channel/item">
      ...
      <div class="small-12 columns" style="text-align: right;">
        <a class="fontel-16 icon-chevron_up" href="#top-of-page"></a>
      </div><!-- /.small-12.columns -->
    </div><!-- /.row -->
